/******************************************************************************
 *  Compilation:  javac -d bin com/bridgelabz/util/BLStdIn.java
 *  Execution:    java -cp bin com.bridgelabz.util.BLStdIn
 *  
 *  Purpose: To make and standard output liabrary
 *
 *  @author  Shritej
 *  @version 1.0
 *  @since   10-08-2017
...
public final class BLStdIn{
	...
	*	@return {@code true} if standard input is empty(except whitespace)
	*			{@code false} if standard input is not empty
	*
	*/
